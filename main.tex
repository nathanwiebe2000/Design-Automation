...
\begin{figure}[t]
  \centering
  \input{pictures/design-flows.tikz}
...
\begin{table*}[t]
  \label{tbl:qnewton}
  \catcode`\_=\active\def_{\hskip1ex}%
  \begin{tabularx}{\linewidth}{Xrrrrrrrrrr}
\hline
    & \multicolumn{2}{c}{\texttt{RESDIV$(n)$}} & \multicolumn{2}{c}{\texttt{FUNCTIONAL$(n)$}}& \multicolumn{2}{c}{\texttt{REVS$(n)$}, $p=0$} & \multicolumn{2}{c}{\texttt{REVS$(n)$}, $p=1$} & \multicolumn{2}{c}{\texttt{HIERARCHICAL$(n)$}}\\
\hline
    $n$ & qubits & $T$-count & qubits & $T$-count \\[3pt]
    __8 & \rev{48}  & \rev{8\,512}   & 16 & 1\,342 & 15  & 51\,386 &20 & 1\,349 & - &-    \\
    _16 & \rev{96}  & \rev{34\,944}  & 31  & 71\,115\,285 & 32 &52\,376& 46 & 42\,717 & 892 & 5\,607     \\
    _32 & \rev{192} & \rev{141\,568} & -  & -& -  & -  & - & - & 3\,501 & 21\,455 \\
    _64 & \rev{384} & \rev{569\,856} & -  & -& - & - & - & - & 13\,465 & 80\,339 \\
 %   128 & 387 & 578\,823 &      &             \\
\hline\\
  \end{tabularx}
  \caption{Synthesis of $f(x)=1/x$ using a hand-crafted restoring division circuit (\texttt{RESDIV}), functional synthesis, ESOP based synthesis using REVS and hierarchical synthesis.  All circuits are based on VERILOG files for integer division.}
\end{table*}
