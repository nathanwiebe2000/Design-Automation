...
\begin{figure}[t]
  ...
  \caption{Design flows; lines represent interfaces between files and tools and
    are annotated using the function representation at the interface}
  \label{fig:design-flows}
\end{figure}

\begin{table*}[t]
  \caption{Baseline results with manual design}
  \label{tbl:qnewton}
